function [negdp, posdp]=...
    w_updates2(V_n, weight, F, negdp, posdp, beta_loss, W_1, H_1_n, WH_1_n, WH_2_n, WH_3_n, WH_4_n, WH_5_n, WH_6_n)
%% Purpose
...
% unsupervised, noise (cry), lung, stethoscope movement and respiratory 
